...
import { FacebookEventType, FunnelStage, Source, TiktokEventType } from '@prisma/client';

export const mapEventToPrismaType = <T extends FacebookEventType | TiktokEventType>(event: Event) => {
  return {
    id: event.eventId,
